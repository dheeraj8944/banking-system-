		 ...
		 function random_function()
            {
				...
				if(a==="ramya"){
				 var arr=["Mahesh","chandu","somesh","vidhya","divya","aditya","usha","mounya","aneesha"];
				 }
				 else if(a==="Mahesh"){
					var arr=["ramya","chandu","somesh","vidhya","divya","aditya","usha","mounya","aneesha"];
				}
				else if(a==="chandu"){
					var arr=["ramya","Mahesh","somesh","vidhya","divya","aditya","usha","mounya","aneesha"];
				}
				else if(a==="somesh"){
					var arr=["ramya","Mahesh","chandu","vidhya","divya","aditya","usha","mounya","aneesha"];
				 }
				 else if(a==="vidhya"){
					var arr=["ramya","Mahesh","somesh","chandu","divya","aditya","usha","mounya","aneesha"];
				 }
				 else if(a==="divya"){
					var arr=["ramya","Mahesh",,"somesh","chandu","vidhya","aditya","usha","mounya","aneesha"];
				 }
				 else if(a==="aditya"){
					var arr=["ramya","Mahesh","somesh","chandu","vidhya","divya","usha","mounya","aneesha"];
				 }
				 else if(a==="usha"){
					var arr=["ramya","Mahesh","somesh","chandu","vidhya","divya","aditya","mounya","aneesha"];
				 }
				 else if(a==="mounya"){
					var arr=["ramya","Mahesh","somesh","chandu","vidhya","divya","aditya","usha","aneesha"];
				 }
				 else if(a==="aneesha"){
				 var arr=["ramya","Mahesh","somesh","chandu","vidhya","divya","aditya","usha","mounya"];
				 }
                var string="";
...
<body>
	...
	<form action="updatecredit.php" method="post">
		...
		<select id="input" name="sender"style="font-size: 12pt; height: 28px; width:290px;" align="middle" onchange="random_function()">
			...
			<option value="mounya">mounya</option>
			<option value="aneesha">aneesha</option>
		</select><br><br>
